    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = isEmail ? await _signInManager.UserManager.FindByEmailAsync(Input.UserNameOrEmail) : await _signInManager.UserManager.FindByNameAsync(Input.UserNameOrEmail);
                if (user == null)
                {
                    username = "111111111";
                }
